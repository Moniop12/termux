...
public final class TermuxPreferenceConstants {
    ...
    public static final class TERMUX_APP {
        ...
        /**
         * TermuxMod: Defines the key for whether storage access (~/storage symlinks)
         * has already been auto-requested once on first run, so we don't nag the
         * user again on every launch if they dismissed/denied it.
         */
